...
PROJECT_REPO ?= github.com/MacroPower/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_VERSION ?= 2023.8.0
...
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-authentik_2023.8.0
...
REGISTRY_ORGS ?= xpkg.upbound.io/jacobcolvin
IMAGES = $(PROJECT_NAME)
...
XPKG_REG_ORGS ?= xpkg.upbound.io/jacobcolvin
# NOTE(hasheddan): skip promoting on xpkg.upbound.io as channel tags are
# inferred.
XPKG_REG_ORGS_NO_PROMOTE ?= xpkg.upbound.io/jacobcolvin
XPKGS = $(PROJECT_NAME)
...
#   You can check the basic implementation here: https://github.com/upbound/uptest/blob/main/internal/authentiks/01-delete.yaml.tmpl.
